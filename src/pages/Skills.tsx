  ...
  return (
    <section className="w-full min-h-screen py-12 px-4 flex flex-col items-center text-foreground">
      <motion.h2
        ...
        className="text-4xl md:text-5xl font-bold mb-2  underline-offset-4 decoration-blue-500"
      >
        My Skills
      </motion.h2>
      ...
      <div className="grid cursor-pointer grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-2 w-full max-w-6xl px-2 sm:px-6">
